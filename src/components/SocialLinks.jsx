...
const SocialLinks = ({ isLoaded }) => {
	...
	return (
		...
		>
			<a href="https://www.linkedin.com/in/sprsh/" target="_blank" rel="noopener noreferrer" className={linkClass}>
				<p className={textClass}>Linkedin</p>
				<ArrowUpRight size={16} className={iconClass} />
			</a>
			<a href="https://github.com/OpsEclipse" target="_blank" rel="noopener noreferrer" className={linkClass}>
				<p className={textClass}>Github</p>
				<ArrowUpRight size={16} className={iconClass} />
			</a>
			<a href="mailto:ss6shah@uwaterloo.ca" className={linkClass}>
